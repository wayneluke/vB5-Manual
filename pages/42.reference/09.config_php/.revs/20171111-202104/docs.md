...
The default configuration file in vBulletin 5. This file controls access to the database along with other functionality that has to be setup before pulling data from the database.
...
/*=========================================================================*\
|| #######################################################################
|| # Downloaded: 12:31, Wed Oct 5th 2016
